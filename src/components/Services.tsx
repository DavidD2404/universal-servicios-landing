...
// Componente de iconos SVG consistentes
function ServiceIcon({ icon, className = "w-8 h-8" }: { icon: string; className?: string }) {
  const icons: Record<string, JSX.Element> = {
    '🛡️': ( // Shield - Redes de Seguridad
...
export default function Services() {
  ...
  return (
    <section id="servicios" className="relative py-14 md:py-16 lg:py-20 bg-gradient-to-b from-white via-neutral-50 to-white overflow-hidden">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16 md:mb-20">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-neutral-600 max-w-3xl mx-auto leading-relaxed">
              Más de 7 años protegiendo hogares y espacios comerciales en Buenos Aires
            </p>
          </motion.div>
            ...
            <div className="bg-gradient-to-br from-primary via-[#0A2F5F] to-primary rounded-3xl md:rounded-[2.5rem] p-8 md:p-12 lg:p-16 max-w-6xl mx-auto shadow-2xl border border-white/10 backdrop-blur-sm">
              ...
              <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
                <div className="text-center group">
                  ...
                  <div className="text-white text-base md:text-lg font-medium opacity-90">Clientes satisfechos</div>
                ...
                <div className="text-center group">
                  ...
                  <div className="text-white text-base md:text-lg font-medium opacity-90">Años de experiencia</div>
                  <div className="w-16 h-1 bg-accent rounded-full mx-auto mt-3" />
                </div>
                <div className="text-center group">
                  <div className="inline-flex items-baseline justify-center mb-3">
                  ...
                  <div className="text-white text-base md:text-lg font-medium opacity-90">Garantía de calidad</div>
                  <div className="w-16 h-1 bg-accent rounded-full mx-auto mt-3" />
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          {/* Featured Service - Redes de Seguridad */}
          <motion.div
            initial={{ opacity: 0, y: 30 }}
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
                  ...
                  <div className="flex items-center gap-5">
                    <div className="relative">
                      ...
                      <div className="relative w-20 h-20 lg:w-24 lg:h-24 bg-secondary/10 rounded-2xl flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform duration-500">
                        <ServiceIcon icon={FEATURED_SERVICE.icon} className="w-12 h-12 lg:w-14 lg:h-14 text-secondary" />
                      </div>
                    </div>
                    <div>
                      ...
                      <p className="text-secondary font-medium text-sm md:text-base mt-1">Servicio destacado</p>
                    </div>
                  </div>
                </div>
                          ...
                          <div className="flex items-start gap-4 mb-6">
                            <div className="relative flex-shrink-0">
                              ...
                              <div className="relative w-16 h-16 bg-secondary/10 rounded-xl flex items-center justify-center group-hover/card:scale-110 transition-transform duration-300">
                                <ServiceIcon icon={subcategory.icon} className="w-8 h-8 text-secondary" />
                              </div>
                            </div>
                            <div className="flex-1">
                          ...
                          <ul className="space-y-3 mb-6">
                            {subcategory.features.map((feature, idx) => (
                              <li key={idx} className="flex items-start gap-3">
                                ...
                                <span className="text-neutral-700 text-sm md:text-base leading-relaxed">{feature}</span>
                              </li>
                            ))}
                          </ul>
                        </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="relative w-20 h-20 lg:w-24 lg:h-24 mb-6">
                      ...
                      <div className="relative w-full h-full bg-primary/10 rounded-2xl flex items-center justify-center shadow-lg group-hover/service:scale-110 transition-transform duration-500">
                        <ServiceIcon icon={service.icon} className="w-10 h-10 lg:w-12 lg:h-12 text-primary" />
                      </div>
                    </div>
