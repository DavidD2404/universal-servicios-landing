                  ...
                  <div className="absolute inset-0 flex">
                    <div className="w-[60%] flex items-center pl-16 pr-8 py-12 text-white z-10">
                      <div className="pt-12">
                        ...
                        >
                          Instalación profesional de redes de protección para
                          <br />
                        ...
                        {[
                          {
                            ...
                            subtitle: "TODO CABA Y BS AS",
                          },
                          {
                            icon: "M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4z",
                            title: "RED MULTIFILAMENTO",
                            subtitle: "RED MONOFILAMENTO",
                          },
                          {
            ...
            >
                  ...
                  <div className="absolute inset-0 flex">
                    ...
                    <div className="w-[55%] flex items-center pl-12 pr-16 py-12 text-white z-10">
                      <div className="pt-16">
                        ...
                        >
                          Instalación profesional y mantenimiento preventivo de
              ...
              <div className="lg:hidden relative bg-primary-darker overflow-hidden">
                ...
                <div className="relative z-10 p-6 md:p-10 py-10 pb-12 text-white h-[500px] sm:h-[560px] md:h-[680px] flex flex-col justify-between overflow-hidden">
                  ...
                  >
                    Instalación profesional y mantenimiento preventivo de Aires
                    acondicionados
                  </motion.p>
                  <motion.div
                    initial={{ opacity: 0 }}
